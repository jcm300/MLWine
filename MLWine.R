...
rnaWine1 <- neuralnet( funcao, dadosTreino, lifesign="full", hidden = c(7,5), threshold = 0.01)
rnaWine2 <- neuralnet( funcaoOpt, dadosTreino, lifesign="full", hidden = c(4,2), threshold = 0.01)
rnaWine3 <- neuralnet( funcaoOpt2, dadosTreino, lifesign="full", hidden = c(5), threshold = 0.01)
